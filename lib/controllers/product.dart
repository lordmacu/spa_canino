...
class Home extends GetxController{
  ...
  getPopulars() async{
    ...
    json["data"].forEach((item){
      ...
      Product product= Product(productItem["title"], productItem["description"], productItem["id"], productItem["image"], productItem["quantity"], productItem["status"], productItem["category"]["name"]);
